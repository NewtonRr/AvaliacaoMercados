import type { PendingScore, ReviewResponse, ReviewTabConfig } from "../models/review";
...
export async function uploadScores(scores: PendingScore[], idLoja: string) {
  await fetch(`/api/${idLoja}/responses/batch`, {
    method: 'POST',
